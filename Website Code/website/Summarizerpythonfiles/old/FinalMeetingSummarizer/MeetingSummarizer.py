...
def generateExtractiveSummary(input_type, input_text,limit_type):
    """Get input text"""
    ...
    sentence_limit = 5
    #Type
    limit_type = limit_type #'sentence' or 'word' or 'retention_percentage'
...
# extractive_summary = generateExtractiveSummary(input_type, input_text,limit_type)
# print('\nExtractive Summary: \n', extractive_summary)
