...
def tokenizeSentences(file):
  ...
  return tokenized_words_without_stopwords, tokenized_sentence
...
def main(text,retention):
    tokenized_words, tokenized_sentences = tokenizeSentences(text)
    ...
    retention_percentage = int(retention)
